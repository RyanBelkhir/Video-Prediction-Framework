...
if config.data.dataset == "MovingMnist":
    ...
    train_set = KTHDataset(data_dir=".data/kth", frames_per_sample=num_frames , train=True)
    test_set = KTHDataset(data_dir=".data/kth", frames_per_sample=num_frames, train=False)
